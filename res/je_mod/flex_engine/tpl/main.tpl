	...
	<div class="josi_store_main_div">
		...
		<div class="josi_store_get_div div_left">
			...
			[[
				...
				rooted:						true&
				parse_arr:					false&
				tab_key:					tab_org_unit&
				label:						Подразделение&
				val_key:					form.zamer.org_unit
			]]
			...
			[[
				...
				rooted:						true&
				parse_arr:					false&
				tab_key:					tab_sale_office&
				label:						Прием. пункт&
				val_key:					form.zamer.sale_office
			]]
				...
				<div 	class="div_left josi_store_form_item_val_div" 
						...
						<div 	class="josi_store_form_input_div text_val_ zamer_mix_val" 
								...
								"
									...
									struct_res_key:		where.tab_org_unit.0.name
									...
									ev:{focus,click}
									^
									f:form_popup_list_show
									^
									root_node_class_name:josi_store_form_item
									...
									f:tpl
									^
									tpl_path:tpl/adv_form/form.tpl&
									node_class_query:.popup_list_div&
									struct_res_key:struct_put_arr.zamer.tab_org_unit.0&
									replace:false&
									rooted:true&
									root_node_class_name:josi_store_form_item_val_div&
									append:false&
									parse_arr:false&
			...
			[[
				f:tpl
				^
				tpl_path:							tpl/order/form/form_item_dt.tpl&
				node_class_query:					&
				rooted:								true&
				parse_arr:							false&
				label:								Дата приема&
				val_key:							form.zamer.dt_make
			]]
			...
			<!--Адрес
			[[f:tpl^tpl_path:tpl/order/form/form_item_text_val.tpl&node_class_query:&rooted:true&parse_arr:false&label:Адрес&val_key:form.zamer.address&post_scl:tpl/order/form/ymap/geocoder.scl]]-->
			...
			[[
				...
				tab_key:					tab_street&
				label:						Улица&
				val_key:					.tab_zamer.0.tab_address.0.tab_street.0.name&
